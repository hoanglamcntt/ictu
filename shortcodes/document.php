<?php
/**
 * Name: document shortcode
 **/
function ictu_document_shortcode( $atts )
{
    ...
    $item_icon             = $atts['item_icon'];
    $item_count            = $atts['item_count'];
    $post_style            = $atts['post_style'];
    $is_dev                = $atts['is_dev'];
                    ...
                    <?php if ( $custom_query->have_posts() ): ?>
                        <?php while ( $custom_query->have_posts() ) : ?>
                            ...
                            <article <?php post_class( $item_classes ); ?> data-order="<?php echo $order ?>">
                                <?php if ( $atts['post_style'] == 'style-02' ) { ?>
                                    <?php
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="post-item-type--document__wrap-link">
                                        <span class="post-item-type--document__link"><i class="<?php echo esc_attr( $item_icon ) ?>" aria-hidden="true"></i></span>
                                    </div>
...
add_shortcode( 'ictu_document', 'ictu_document_shortcode' );