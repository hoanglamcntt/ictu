...
if ( !class_exists( 'Theme_Widget_Related_Posts' ) ) {
    class Theme_Widget_Related_Posts extends OVIC_Widget
    {

        public function __construct()
        {
            $this->widget_cssclass    = 'theme-widget theme-widget-related-posts';
            $this->widget_description = __( 'List related posts', 'ictu' );
            $this->widget_id          = 'theme-widget-related-posts';
            $this->widget_name        = __( 'Theme: Related Posts', 'ictu' );
            $this->settings           = apply_filters(
                'theme-widget-related-posts-settings',
                array(
                    'title'          => array(
                        'id'    => 'title',
                        'type'  => 'text',
        ...
        public function widget( $args, $instance )
        {
            ...
            <?php
            echo apply_filters( 'theme-widget-related-posts', ob_get_clean(), $instance );
