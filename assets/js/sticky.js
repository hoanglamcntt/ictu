(function ($) {
    ...
    window.addEventListener("load", function load() {
         ...
         * </div>
         *
         * @use: $('.sticky-content').tuongnam_sticky_sidebar();
         * */
        $.fn.tuongnam_sticky_sidebar = function () {
            var $this = $(this);
            if ( $this.closest('.wrapper-main-content').length ) {
                ...
                $this.on('tuongnam_sticky_sidebar', function () {
                    $this.each(function () {
                        ...
                        $(window).on('scroll tuongnam_load_more_post', function () {
                ...
                }).trigger('tuongnam_sticky_sidebar');
        ...
        if ( $('.sticky-content').length ) {
            $('.sticky-content').tuongnam_sticky_sidebar();
        }
    }, false);
